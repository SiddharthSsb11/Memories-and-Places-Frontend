...
> Share the Memories you created and Paces you visited with the world. 
...
You can find the backend server-side code repo for this project [here](https://github.com/SiddharthSsb11/Memories-and-Places-Backend).
...
- All the Memories created and Places shared are stored in the database i.e. <i>persistant</i>
